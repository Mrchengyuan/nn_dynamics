...
&nbsp;&nbsp;&nbsp;&nbsp;*When `--might_render` or `--visualize_MPC_rollout` is specified, the environment will be created with Gym's human render mode so you can watch the rollouts in real time.*
